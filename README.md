...
Modules:
 ...
 2) algors.py: It contains an algorithm that merges a group of apertures forming in a very small range to avoid multiple aperture placements over a single object, and therefore containing the functions to store the 
